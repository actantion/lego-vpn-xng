...
class TenonMainWindowsController: NSWindowController,NSTableViewDelegate,NSTableViewDataSource,NSGestureRecognizerDelegate {
    @IBOutlet  var progressCircularProgress: CircularProgress!
    @IBOutlet  var notConnectProgress: CircularProgress!
    @IBOutlet  var connectedProgress: CircularProgress!
    @IBOutlet  var lbUpgrade: NSTextField!
    @IBOutlet  var btnUpgrade: NSButton!
    @IBOutlet  var lbTenon: NSTextField!
    @IBOutlet  var popMenuTableView: NSTableView!
    @IBOutlet  var popMenu: NSView!
    @IBOutlet  var baseView: NSView!
    @IBOutlet  var btnChoseCountry: NSButton!
    @IBOutlet  var lbConnect: NSTextField!
    @IBOutlet  var imgConnect: NSImageView!
    @IBOutlet  var cbRouteSwitch: NSButton!
    @IBOutlet  var btnConnect: NSButton!
    
    @IBOutlet  var lbCountryName: NSTextField!
    @IBOutlet  var lbNodeCount: NSTextField!
    @IBOutlet  var imgCountry: NSImageView!
    @IBOutlet  var exitButton: NSButton!
    @IBOutlet  var settingsBtn: NSButton!
    @IBOutlet  var upgradeBtn: NSButton!
    ...
    @IBAction func clickShare(_ sender: Any) {
        ...
        pasteboard.setString(TenonP2pLib.sharedInstance.share_ip + "?id=" + TenonP2pLib.sharedInstance.account_id_, forType: NSPasteboard.PasteboardType.string)
    ...
    func updateServerInfo(show_upgrade: Bool) {
        ...
        for item in plats {
            ...
            if (item_split[0] == "share_ip") {
                if (String(item_split[1]).starts(with: "http")) {
                    TenonP2pLib.sharedInstance.share_ip = String(item_split[1])
                } else {
                    TenonP2pLib.sharedInstance.share_ip = "http://" + String(item_split[1])
                }
            ...
            if (item_split[0] == "buy_ip") {
                if (String(item_split[1]).starts(with: "http")) {
                    ...
                    TenonP2pLib.sharedInstance.buy_tenon_ip = "http://" + String(item_split[1])
                }
            }
        }
